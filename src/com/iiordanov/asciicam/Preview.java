...
class Preview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        ...
        try {
        	...
        	cam.showExceptionDialog("Could not access camera",
        			"The application could not access your camera to show you a preview " +
        			"and take pictures. Please restart your device.");
        }
    }
